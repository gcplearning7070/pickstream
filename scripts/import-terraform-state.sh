...
terraform import google_compute_address.webapp_static_ip projects/gcp-terraform-demo-474514/regions/us-central1/addresses/random-names-webapp-instance-static-ip
...
terraform import google_compute_instance.webapp_instance projects/gcp-terraform-demo-474514/zones/us-central1-a/instances/random-names-webapp-instance
